...
public class ScoreDatabaseAssetsResource implements ScoreDatabase {
    private Context context;

    public ScoreDatabaseAssetsResource(Context context) {
    ...
    public List<String> listScores(int size) {
        ...
        try {
            InputStream f = context.getAssets().open("directory/highScores.txt");
